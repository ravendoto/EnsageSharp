...
namespace WraithKingCombo
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("> Wraith King# loaded!");
        ...
        public static void Game_OnUpdate(EventArgs args)
        {
            ...
            if (!Game.IsInGame || me.ClassID != ClassID.CDOTA_Unit_Hero_SkeletonKing)
            {
                return;
            }
            ...
            if (activated)
            {
                ...
                if (target.IsAlive && !target.IsInvul())
                {
                    ...
                    if (target.IsVisible && me.Distance2D(target) <= 1200)
                    {
                        if (Q.CanBeCasted() &&
                            blink.CanBeCasted()  &&
                            me.Position.Distance2D(target.Position) > 500 &&
